...
\begin{tabular}{
  ...
  & Code & $\epsilon$ \\
  & & \varstyle{InstList}
  % & ExprArithm & \varstyle{ExprArithm} + \varstyle{Priority3ExprArithm} \\
  % & & \varstyle{ExprArithm} - \varstyle{Priority3ExprArithm} \\
  % & & \varstyle{Priority3ExprArithm} \\
  % & Priority3ExprArithm & $\varstyle{Priority3ExprArithm} * \varstyle{Priority4ExprArithm}$ \\
  % & & \varstyle{Priority3ExprArithm} / \varstyle{Priority4ExprArithm} \\
\end{tabular}
\end{document}
