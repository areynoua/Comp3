...
<Code> & epsilon [VarName] rand print read for while if  & else end endif done \\ \hline
...
<InstList> & [VarName] rand print read for while if  & else end endif done \\ \hline
...
<Instruction> & [VarName] rand print read for while if  & else end endif ; done \\ \hline
